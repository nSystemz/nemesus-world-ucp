    ...
    <div class="col-md-12 mt-1">
        <div class="box box-default">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">Ticketarchiv (Die letzten 125 Tickets)</div>
                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <table id="logtable" class="table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    @if (Auth::user()->adminlevel >= FunctionsController::getAdminLevel($data->admin))
                                        <tr>
                                            <td>{{$data->id}}</td>
                                            @if($data->prio == 'low')
                                            ...
                                            <td><span class="badge bg-primary">{{FunctionsController::getTicketStatus($data->status)}}</span></td>
