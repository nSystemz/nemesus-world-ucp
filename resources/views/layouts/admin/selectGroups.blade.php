                                    ...
                                    <div class="table-responsive-md mt-2">
                                        <table id="logtable" class="table table-bordered" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><a style="color:rgba(255, 255, 255, 0.685)" href="/adminGroups/{{$data->id}}">{{$data->name}}</a></td></td>
                                                    <td>{{FunctionsController::getGroupMembers($data->id)}}</td>
                                                    <td>{{FunctionsController::getGroupStatus($data->status)}}</td>
